		...
		<main>
			<div class="row">
				...
				<div id="content" class="col-80">
					...
					<div class="btn-ctr">
						<!--<a href="#" class="btn left"><i class="fa fa-chevron-left"></i>Materi Sebelumnya</a>-->
						<a href="#" class="btn right">Materi Selanjutnya<i class="fa fa-chevron-right"></i></a>
					</div>
					<div class="line"></div>
					<section>
					...
					<section id="example">
						...
						<p>Di bawah ini merupakan contoh query materi, silahkan ubah query jika anda ingin mencoba sendiri</p>
						<div id="sandbox">
